...
const KEYS = [
  ...
  "repo.wiki",
  "repo.builds",
  "repo.builds.empty_title",
  "repo.builds.empty_desc",
  "repo.builds.state_pending",
  "repo.builds.state_running",
  "repo.builds.state_success",
  "repo.builds.state_failure",
  "repo.builds.state_error",
  "repo.builds.view_on_ci",
  "repo.builds.for_commit",
  "repo.builds.attempts",
  "repo.watch",
  "repo.unwatch",
  "repo.star",
  "repo.starred",
